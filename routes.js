...
exports = module.exports = function(app, passport) {
  ...
  app.get('/online/', require('./views/online/index').init);
  app.get('/new/', require('./views/new/index').init);
  ...
  //=======
  app.get('/slide', require('./views/unsplash/index').init); 
  //>>>>>>> 67fba8d3d929d2e616838d6de0e02e41f5578e9d
